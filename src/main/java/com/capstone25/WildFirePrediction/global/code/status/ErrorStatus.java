...
public enum ErrorStatus implements BaseErrorCode {
    ...
    // 재난문자 API 전용 에러
    EMERGENCY_API_CONFIG_MISSING(HttpStatus.INTERNAL_SERVER_ERROR, "EMERGENCY500", "재난문자 API 설정을 찾을 수 없습니다."),
    ...
    // 기상특보 API 전용 에러
    WEATHER_WARNING_API_CONFIG_MISSING(HttpStatus.INTERNAL_SERVER_ERROR, "WEATHER500", "기상특보 API 설정을 찾을 수 없습니다."),
    WEATHER_WARNING_API_SERVICE_KEY_INVALID(HttpStatus.UNAUTHORIZED, "WEATHER401", "기상특보 API 서비스키가 유효하지 않습니다."),
