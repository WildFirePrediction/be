...
public enum ErrorStatus implements BaseErrorCode {
    ...
    // Public Api Service 범용 에러
    API_CONFIG_MISSING(HttpStatus.INTERNAL_SERVER_ERROR, "PUBLICAPI500", "API 설정을 찾을 수 없습니다."),
    API_SERVICE_KEY_INVALID(HttpStatus.UNAUTHORIZED, "PUBLICAPI401", "API 서비스키가 유효하지 않습니다."),
    API_CALL_FAILED(HttpStatus.SERVICE_UNAVAILABLE, "PUBLICAPI503", "API 호출에 실패했습니다."),
    API_RESPONSE_INVALID(HttpStatus.BAD_REQUEST, "PUBLICAPI400", "API 응답 형식이 잘못되었습니다.");
